...
$(document).ready(function () {
  ...
  var carousel = $("#honda-carousel");
  $("#hondaSubmenu li:nth-child(1) a").click(function (e) {
    e.preventDefault();
    carousel.trigger("to.owl.carousel", [0, 500, true]);
    //adding glowing animation to selected card and remove others
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#honda-carousel > div.card-1").removeClass("glow");
    $("#honda-carousel div.card-1").addClass("glow");
  });
  $("#hondaSubmenu li:nth-child(2) a").click(function (e) {
    e.preventDefault();
    carousel.trigger("to.owl.carousel", [1, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#honda-carousel > div.card-2").removeClass("glow");
    $("#honda-carousel div.card-2").addClass("glow");
  });
  $("#hondaSubmenu li:nth-child(3) a").click(function (e) {
    e.preventDefault();
    carousel.trigger("to.owl.carousel", [2, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#honda-carousel > div.card-3").removeClass("glow");
    $("#honda-carousel div.card-3").addClass("glow");
  });
  $("#hondaSubmenu li:nth-child(4) a").click(function (e) {
    e.preventDefault();
    carousel.trigger("to.owl.carousel", [3, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#honda-carousel > div.card-4").removeClass("glow");
    $("#honda-carousel div.card-4").addClass("glow");
  });
  $("#hondaSubmenu li:nth-child(5) a").click(function (e) {
    e.preventDefault();
    carousel.trigger("to.owl.carousel", [4, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#honda-carousel > div.card-5").removeClass("glow");
    $("#honda-carousel div.card-5").addClass("glow");
  });

  var carousel2 = $("#suzuki-carousel");
  $("#suzukiSubmenu li:nth-child(1) a").click(function (e) {
    e.preventDefault();
    carousel2.trigger("to.owl.carousel", [0, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#suzuki-carousel > div.card-1").removeClass("glow");
    $("#suzuki-carousel div.card-1").addClass("glow");
  });
  $("#suzukiSubmenu li:nth-child(2) a").click(function (e) {
    e.preventDefault();
    carousel2.trigger("to.owl.carousel", [1, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#suzuki-carousel > div.card-2").removeClass("glow");
    $("#suzuki-carousel div.card-2").addClass("glow");
  });
  $("#suzukiSubmenu li:nth-child(3) a").click(function (e) {
    e.preventDefault();
    carousel2.trigger("to.owl.carousel", [2, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#suzuki-carousel > div.card-3").removeClass("glow");
    $("#suzuki-carousel div.card-3").addClass("glow");
  });
  $("#suzukiSubmenu li:nth-child(4) a").click(function (e) {
    e.preventDefault();
    carousel2.trigger("to.owl.carousel", [3, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#suzuki-carousel > div.card-4").removeClass("glow");
    $("#suzuki-carousel div.card-4").addClass("glow");
  });
  $("#suzukiSubmenu li:nth-child(5) a").click(function (e) {
    e.preventDefault();
    carousel2.trigger("to.owl.carousel", [4, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#suzuki-carousel > div.card-5").removeClass("glow");
    $("#suzuki-carousel div.card-5").addClass("glow");
  });

  var carousel3 = $("#ford-carousel");
  $("#fordSubmenu li:nth-child(1) a").click(function (e) {
    e.preventDefault();
    carousel3.trigger("to.owl.carousel", [0, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#ford-carousel > div.card-1").removeClass("glow");
    $("#ford-carousel div.card-1").addClass("glow");
  });
  $("#fordSubmenu li:nth-child(2) a").click(function (e) {
    e.preventDefault();
    carousel3.trigger("to.owl.carousel", [1, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#ford-carousel > div.card-2").removeClass("glow");
    $("#ford-carousel div.card-2").addClass("glow");
  });
  $("#fordSubmenu li:nth-child(3) a").click(function (e) {
    e.preventDefault();
    carousel3.trigger("to.owl.carousel", [2, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#ford-carousel > div.card-3").removeClass("glow");
    $("#ford-carousel div.card-3").addClass("glow");
  });
  $("#fordSubmenu li:nth-child(4) a").click(function (e) {
    e.preventDefault();
    carousel3.trigger("to.owl.carousel", [3, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#ford-carousel > div.card-4").removeClass("glow");
    $("#ford-carousel div.card-4").addClass("glow");
  });
  $("#fordSubmenu li:nth-child(5) a").click(function (e) {
    e.preventDefault();
    carousel3.trigger("to.owl.carousel", [4, 500, true]);
    $("a").not(this).removeClass("active");
    $(this).addClass("active");
    $("div").not("#ford-carousel > div.card-5").removeClass("glow");
    $("#ford-carousel div.card-5").addClass("glow");
  });
...
function data() {
  document.getElementById("ketqua").innerHTML =
    "<i class='far fa-check-circle'></i> We've received your report.";
}
