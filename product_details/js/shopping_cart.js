...
function displayCart() {
  ...
  for (var i in cartArray) {
    output +=
      ...
      cartArray[i].price +
      "</b></td>" +
      "<td><div class='input-group'><button class='minus-item input-group-addon btn btn-primary p-0' data-name=" +
      cartArray[i].name +
      ">-</button>" +
      ...
      cartArray[i].count +
      "'>" +
      "<button class='plus-item btn btn-primary input-group-addon p-0' data-name=" +
      cartArray[i].name +
      ">+</button></div></td>" +
  ...
  } else $("span.total-count").removeClass("d-none");
}
